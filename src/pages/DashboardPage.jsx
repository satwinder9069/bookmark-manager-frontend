...
const DashboardPage = () => {
    ...
    return (
        <div className="flex min-h-screen bg-gray-200 dark:bg-gray-900 text-black dark:text-white transition-colors duration-300">
            ...
            <div className={`fixed inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 transition-transform duration-200 ease-in-out z-30`}>
                <Sidebar
            ...
            <div className="flex-1 p-4 md:p-8 lg:p-12 relative z-10">
                <button
                onClick={handleToggleSidebar}
